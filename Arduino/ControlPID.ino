/* Adaptado del codigo de: http://www.youtube.com/c/electronoobs
 * Arduino NANO pin    |   MPU6050
 * 5V                  |   Vcc
 * GND                 |   GND
 * A4                  |   SDA
 * A5                  |   SCL
...
//Creamos variables para los valores de ancho de tiempo de cada señal de entrada PWM
unsigned long counter_1, counter_2, counter_3, counter_4, current_count;

//Creamos 4 variables para detener el valor anterior de la señal de entrada (si es BAJO o ALTO)
...
void loop() {
 ...
 after that we substract the error value found before*/
  ...
  /*///////////////////////////P I D///////////////////////////////////*/
  /* Se añaden los valores recibidos por la comunicaión serial los cuales daran dirección al dron*/
  if(Serial.read() == "f"){
    //Adelante
    input_ROLL = 2000;
